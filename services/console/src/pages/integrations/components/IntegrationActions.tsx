...
export const IntegrationActions: React.FC<IntegrationActionsProps> = ({
  ...
  const canTestConnection = integration.status === 'connected' || integration.status === 'error';
      ...
      <CardContent>
        ...
        <div className="mt-6 space-y-3 text-sm text-muted-foreground">
          <div className="flex items-start space-x-2">
            ...
            <p>
              <strong>Test Connection:</strong> Verify that the integration is working correctly 
              and can communicate with {connector.name}.
            </p>
          </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <p>
              <strong>Reconfigure:</strong> Update permissions or reconnect to {connector.name} 
              with new settings.
            </p>
          </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <p>
              <strong>Disconnect:</strong> Remove this integration and revoke all permissions. 
          ...
          <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-3">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm">
                <p className="text-blue-800 font-medium">Slack Integration Notes</p>
                <ul className="text-blue-700 mt-1 space-y-1 list-disc list-inside">
                  ...
                  <li>Test connection verifies bot permissions and channel access</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        {connector.type === 'github' && (
          <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-3">
            <div className="flex items-start space-x-2">
              <AlertTriangle className="h-4 w-4 text-blue-600 mt-0.5" />
              <div className="text-sm">
                <p className="text-blue-800 font-medium">GitHub Integration Notes</p>
                <ul className="text-blue-700 mt-1 space-y-1 list-disc list-inside">
                  <li>Reconfiguring will update the GitHub App installation</li>
                  <li>Disconnecting will uninstall the app from your repositories</li>
                  <li>Test connection verifies webhook delivery and API access</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm">
                ...
                <p className="text-red-700 mt-1">
                  This integration is experiencing issues. Try testing the connection 
                  or reconfiguring to resolve the problem.
                </p>
              </div>
            </div>
          </div>
