...
type AgentServiceClient interface {
	...
	ProcessMessage(ctx context.Context, in *AgentRequest, opts ...grpc.CallOption) (*AgentResponse, error)
}
...
func (c *agentServiceClient) ProcessMessage(ctx context.Context, in *AgentRequest, opts ...grpc.CallOption) (*AgentResponse, error) {
...
type AgentServiceServer interface {
	// Process a message and return an intelligent response
	ProcessMessage(context.Context, *AgentRequest) (*AgentResponse, error)
...
func (UnimplementedAgentServiceServer) ProcessMessage(context.Context, *AgentRequest) (*AgentResponse, error) {
...
func _AgentService_ProcessMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).ProcessMessage(ctx, req.(*AgentRequest))
	}
